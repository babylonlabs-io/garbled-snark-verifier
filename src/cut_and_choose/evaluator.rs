    ...
    H: LabelCommitHasher,
{
    ...
    pub fn run_regarbling_test<CSourceProvider, CHandlerProvider, F>(
        &mut self,
        seeds: Vec<(usize, Seed)>,
        ciphertext_sources_provider: &CSourceProvider,
        ciphertext_handler_provider: &CHandlerProvider,
...
mod easy_test {
    ...
    pub(super) fn run_regarbling_test<I, H, CSourceProvider, CHandlerProvider, F>(
